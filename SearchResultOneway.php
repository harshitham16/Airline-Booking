...
<nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="frontpage.html"><span class="glyphicon glyphicon-home"></span> Home</a>
            </div>
    ...
    while($row = mysqli_fetch_array($result)) {
        ...
        echo "<td>" . $row['price'] . "</td>";
            ...
            if(mysqli_num_rows($reserved)>0){            
                $availableNumber = $capacityNumber['capacity'] - $reservedNumber['reserved'];
            }else{
